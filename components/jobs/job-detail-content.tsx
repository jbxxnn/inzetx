      ...
      {/* Header Section */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8 lg:mb-10">
            <div className="flex items-center gap-4">
              ...
              >
                <Link href={role === 'client' ? "/dashboard/jobs" : "/dashboard/invites"}>
            ...
            <div className="lg:col-span-2 flex flex-col gap-4 sm:gap-6">
              ...
              <Card className="bg-primary-foreground border-2 border-secondary/50 hover:border-primary/50 transition-all duration-300">
                ...
                <CardContent className="flex flex-col gap-4 sm:gap-6">
                  {locationStr && (
                    <div className="flex items-start gap-3 sm:gap-4 p-4 bg-secondary rounded-xl border border-secondary-foreground/10">
                  ...
                  {job.budget && extractPrice(job.budget) > 0 && (
                    <div className="flex items-start gap-3 sm:gap-4 p-4 bg-secondary rounded-xl border-2 border-primary">
                      <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center shrink-0">
                        <HugeiconsIcon icon={CoinsEuroIcon} className="w-5 h-5 text-secondary-foreground" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="font-heading font-semibold text-primary mb-1">Budget</p>
              ...
              <Card className="bg-primary-foreground border-2 border-secondary/50 hover:border-primary/50 transition-all duration-300">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center">
                      <HugeiconsIcon icon={CheckmarkCircle02Icon} className="w-5 h-5 text-secondary-foreground" />
                    </div>
                    <div>
