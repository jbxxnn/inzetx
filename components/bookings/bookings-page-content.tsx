...
export function BookingsPageContent({ bookings, role }: BookingsPageContentProps) {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'upcoming':
        return (
          <Badge className="bg-yellow-500/20 text-yellow-700 border border-yellow-500/30 rounded-full px-3 py-1 font-semibold">
            Upcoming
          </Badge>
        );
      case 'completed':
      ...
      case 'cancelled':
        return (
          <Badge className="bg-red-500/20 text-red-700 border border-red-500/30 rounded-full px-3 py-1 font-semibold">
            Cancelled
          </Badge>
        );
      default:
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <CardTitle className="text-lg sm:text-xl font-heading font-bold text-secondary-foreground line-clamp-2 transition-colors">
                          {job?.description
                      ...
                      <p className="text-sm text-secondary-foreground ml-[52px]">
                ...
                <CardContent className="space-y-4">
                  {job && (
                    <div className="flex flex-col gap-3">
                      <p className="text-sm sm:text-base text-secondary-foreground line-clamp-3 leading-relaxed">
                        {job.description}
                      </p>
                      {locationStr && (
